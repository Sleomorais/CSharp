...
namespace OperacoesDateTime
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("6) Kind: " + d.Kind);// Tipo Local/Universal
            Console.WriteLine("7) Millisecond: " + d.Millisecond);//Milesegundos
            Console.WriteLine("8) Minute: " + d.Minute);//Minutos
            Console.WriteLine("9) Month: " + d.Month);//Mês
            Console.WriteLine("10) Second: " + d.Second);//Segundos
            Console.WriteLine("11) Ticks: " + d.Ticks);//Quantidade de Ticks
            Console.WriteLine("12) TimeOfDay: " + d.TimeOfDay);//Hora do Dia
